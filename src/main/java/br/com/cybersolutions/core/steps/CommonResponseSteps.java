...
public class CommonResponseSteps {
 ...
 //   private final Long timeResponse = 1L;
    ...
    public void receboResponse(String obj, int statusCode, DataTable dataTable) throws Exception {
        ...
        ResponseHandler.response
                ...
                .time(Matchers.lessThan(100000L))
                .body("", Matchers.is(expectedJson.getMap("")));
    }

    @Then("recebo a response com status {int} os dados")
    ...
    public void receboResponseComStatus(int statusCode) {
    	 ResponseHandler.response
         .then()
         .statusCode(statusCode)
             .time(Matchers.lessThan(100000L))
