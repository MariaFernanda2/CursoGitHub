...
public class Props {
    ...
    static {
        try {
            ...
            props.load(new FileInputStream("src/main/resources/honey-options.properties"));
            ...
            System.out.println("Verifique se o arquivo honey-options-example.properties existe na pasta resources");
            e.printStackTrace();
        } catch (IOException e) {
